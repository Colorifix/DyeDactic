...
if __name__ == "__main__":
    ...
    # colours from spectra obtained from MD sampling
    mol.absorption_spectrum_from_file('data/biliverdin_pH_dependence_MD.csv')
    mol.generate_colour_vs_pH_from_sampled_spectra_biliverdin()

    mol.visualize_species_distribution(sampled_spectrum=True)
